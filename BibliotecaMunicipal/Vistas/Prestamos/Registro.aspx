...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container mt-4">
            ...
            <div class="form-group">
                <asp:Button ID="BtnGuardarPrestamo" runat="server" OnClick="BtnGuardarPrestamo_Click" Text="Guardar  prestamo" class="btn btn-success" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                Cantidad&nbsp;
                <asp:TextBox ID="Cantidad" runat="server" class="form-control" Width="100px"></asp:TextBox>
            </div>
            <div class="form-group">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fecha entrega&nbsp;
                <asp:TextBox ID="FechaEntrega" runat="server" class="form-control" ></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:TextBox ID="IdPrestamo" runat="server" Visible="False" class="form-control"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Button ID="GuardarDetalles" runat="server" OnClick="GuardarDetalles_Click" Text="Agregar" class="btn btn-success" />
